...
import { AfterViewInit, ChangeDetectionStrategy, ChangeDetectorRef, Component, ComponentRef, ElementRef, NgModule, NgZone, OnDestroy, PLATFORM_ID, Renderer2, Type, ViewChild, ViewEncapsulation, ViewRef, inject } from '@angular/core';
