...
import { AfterContentInit, booleanAttribute, ChangeDetectionStrategy, ChangeDetectorRef, Component, ContentChildren, ElementRef, EventEmitter, HostListener, Input, NgModule, NgZone, numberAttribute, OnDestroy, Output, PLATFORM_ID, QueryList, Renderer2, TemplateRef, ViewEncapsulation, ViewRef, inject } from '@angular/core';
