...
import { AfterContentInit, ChangeDetectionStrategy, ChangeDetectorRef, Component, ContentChildren, Directive, DoCheck, ElementRef, EventEmitter, HostListener, Input, NgModule, NgZone, OnDestroy, OnInit, Output, PLATFORM_ID, Pipe, PipeTransform, QueryList, Renderer2, TemplateRef, ViewChild, ViewEncapsulation, booleanAttribute, forwardRef, numberAttribute, inject } from '@angular/core';
