...
import { AfterContentInit, ChangeDetectionStrategy, ChangeDetectorRef, Component, ContentChildren, ElementRef, EventEmitter, Input, NgModule, OnDestroy, OnInit, Output, PLATFORM_ID, QueryList, Renderer2, TemplateRef, ViewChild, ViewContainerRef, ViewEncapsulation, ViewRef, booleanAttribute, effect, numberAttribute, signal, inject } from '@angular/core';
...
export class ContextMenuSub {
    ...
    private ref = inject(ViewContainerRef);
