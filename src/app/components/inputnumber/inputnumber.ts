...
import { AfterContentInit, ChangeDetectionStrategy, ChangeDetectorRef, Component, ContentChildren, ElementRef, EventEmitter, Injector, Input, NgModule, OnChanges, OnInit, Output, QueryList, SimpleChanges, TemplateRef, ViewChild, ViewEncapsulation, booleanAttribute, forwardRef, numberAttribute, inject } from '@angular/core';
...
export class InputNumber implements OnInit, AfterContentInit, OnChanges, ControlValueAccessor {
     ...
     * @group Props
     */
    @Input() mode: 'decimal' | 'percent' | 'currency' = 'decimal';
    /**
     * The currency to use in currency formatting. Possible values are the ISO 4217 currency codes, such as "USD" for the US dollar, "EUR" for the euro, or "CNY" for the Chinese RMB. There is no default value; if the style is "currency", the currency property must be provided.
     * @group Props
     */
    @Input() currency: string | undefined = undefined as keyof {
     ...
     * @group Props
     */
    @Input() currencyDisplay: 'code' | 'symbol' | 'name' | undefined;
    /**
