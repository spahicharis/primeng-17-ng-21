...
import { AfterContentInit, ChangeDetectionStrategy, ChangeDetectorRef, Component, ContentChildren, ElementRef, EventEmitter, HostListener, Input, NgModule, OnDestroy, QueryList, Renderer2, TemplateRef, ViewEncapsulation, booleanAttribute, numberAttribute, inject } from '@angular/core';
