...
import { AfterContentInit, AfterViewInit, ChangeDetectionStrategy, ChangeDetectorRef, Component, ContentChildren, ElementRef, EventEmitter, Input, NgModule, OnDestroy, Output, QueryList, Renderer2, TemplateRef, ViewEncapsulation, booleanAttribute, numberAttribute, inject } from '@angular/core';
