...
@Component({
    ...
    template: `
        <app-docsectiontext>
            ...
            <app-code [code]="code1" [hideToggleCode]="true" />
            ...
            <app-code [code]="code2" [hideToggleCode]="true" />
            ...
            <app-code [code]="code3" [hideToggleCode]="true" />
            <p class="doc-section-description mt-3">
            ...
            <app-code [code]="code4" [hideToggleCode]="true" />
