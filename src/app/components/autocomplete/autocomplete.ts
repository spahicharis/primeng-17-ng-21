...
import { AfterContentInit, AfterViewChecked, booleanAttribute, ChangeDetectionStrategy, ChangeDetectorRef, Component, computed, ContentChildren, effect, ElementRef, EventEmitter, forwardRef, Input, NgModule, NgZone, numberAttribute, OnDestroy, Output, QueryList, Renderer2, signal, TemplateRef, ViewChild, ViewEncapsulation, inject } from '@angular/core';
