...
import { AfterContentInit, ChangeDetectionStrategy, Component, ContentChild, ContentChildren, ElementRef, EventEmitter, Input, NgModule, Output, PLATFORM_ID, QueryList, TemplateRef, ViewEncapsulation, afterNextRender, forwardRef, inject } from '@angular/core';
