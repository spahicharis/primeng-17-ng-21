...
import { AfterViewInit, ChangeDetectionStrategy, Component, Directive, ElementRef, Input, NgModule, Renderer2, OnChanges, SimpleChanges, ViewEncapsulation, booleanAttribute, inject } from '@angular/core';
...
@Component({
    selector: 'p-badge',
    template: ` @if (!badgeDisabled) {<span [ngClass]="containerClass()" [class]="styleClass" [ngStyle]="style">{{ value }}</span>} `,
