...
import { AfterContentInit, AfterViewChecked, AfterViewInit, booleanAttribute, ChangeDetectionStrategy, ChangeDetectorRef, Component, computed, ContentChild, ContentChildren, effect, ElementRef, EventEmitter, forwardRef, Input, NgModule, NgZone, numberAttribute, OnInit, Output, QueryList, Renderer2, Signal, signal, TemplateRef, ViewChild, ViewEncapsulation, inject } from '@angular/core';
